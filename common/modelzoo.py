...
_default_model_info = {
    'imagenet1k-caffenet': {'symbol':_base_model_url+'imagenet/caffenet/caffenet-symbol.json',
                            'params':_base_model_url+'imagenet/caffenet/caffenet-0000.params'},
    'imagenet1k-squeezenet': {'symbol':_base_model_url+'imagenet/squeezenet/squeezenet_v1.1-symbol.json',
                              'params':_base_model_url+'imagenet/squeezenet/squeezenet_v1.1-0000.params'},
    'imagenet1k-nin': {'symbol':_base_model_url+'imagenet/nin/nin-symbol.json',
                       'params':_base_model_url+'imagenet/nin/nin-0000.params'},
    'imagenet1k-vgg16': {'symbol':_base_model_url+'imagenet/vgg/vgg16-symbol.json',
                         'params':_base_model_url+'imagenet/vgg/vgg16-0000.params'},
    'imagenet1k-vgg19': {'symbol':_base_model_url+'imagenet/vgg/vgg19-symbol.json',
    ...
    'imagenet1k-inception-v3': {'symbol':_dummy_model_url+'inception-v3-symbol.json',
                                'params':_dummy_model_url+'inception-v3-0000.params'},
    ...
    'imagenet1k-resnet-200': {'symbol':_base_model_url+'imagenet/resnet/200-layers/resnet-200-symbol.json',
                             'params':_base_model_url+'imagenet/resnet/200-layers/resnet-200-0000.params'},
    'imagenet1k-densenet-169': {'symbol':_dummy_model_url+'imagenet1k-densenet-169-symbol.json',
                                'params':_dummy_model_url+'imagenet1k-densenet-169-0000.params'},
    'imagenet1k-se-resnext-50': {'symbol':_dummy_model_url+'imagenet1k-se-resnext-50-symbol.json',
                                 'params':_dummy_model_url+'imagenet1k-se-resnext-50-0000.params'},
    'imagenet1k-se-resnext-152': {'symbol':_dummy_model_url+'imagenet1k-se-resnext-152-symbol.json',
                                  'params':_dummy_model_url+'imagenet1k-se-resnext-152-0000.params'},
